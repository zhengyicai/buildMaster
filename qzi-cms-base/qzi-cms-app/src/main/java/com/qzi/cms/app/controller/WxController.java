...
public class WxController {
    ...
    private String url = "http://youmo.umo119.com"; //回调接口
    private String pageUrl = "http://youmohome.umo119.com/menzha/userAdd.html";  //返回页面
    private String authPageUrl = "http://youmohome.umo119.com/menzha/home.html";  //访客授权页面
